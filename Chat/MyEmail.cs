/* 发送邮件的调用方法：
 * (1)邮箱必须设置一下，163的容易设置；qq邮箱不怎么支持。
 
                string senderServerIp = "smtp.163.com";             
                string mailPort = "25";            
                string mailUsername =  "qq1012587996"; // 用户名必须是邮箱地址的前缀
                string fromMailAddress =  "qq1012587996@163.com";  
                string mailPassword = "密码"; 
                string toMailAddress = "1@juanpi.com,2@juanpi.com,3@juanpi.com"; // 多用户使用逗号间隔

                string subjectInfo = "爬虫监控"; // 主题
                string bodyInfo = Message + StackTrace; // 内容                
                ...
                //string attachPath = ""; // "E:\\123123.txt; E:\\haha.pdf";//如果有附件，就是路径
                //email.AddAttachments(attachPath);
                string sMsg = email.Send();
*/
using System;
