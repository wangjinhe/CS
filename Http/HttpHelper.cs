/*说明：
 * 1,Connection = "KeepAlive" 通过 request.KeepAlive = true; 来设置
  1, 2016-4-14  update by yixiu
 * 在HttpResult中增加Exception，保存下载过程中的异常。
 * 通过判断 Exception != null 判断下载出现异常。
 * 
 * 
 */
...
namespace CS.Http
{
    ...
    public class HttpHelper
    {
        ...
        public HttpResult GetHtml(HttpItem item)
        {
            ...
            {
                //配置参数时出错
                return new HttpResult() { Cookie = string.Empty, Header = null, Html = ex.Message, StatusDescription = "配置参数时出错：" + ex.Message,Exception = ex };
            }
            try
            {
                //请求数据
        ...
        private void SetRequest(HttpItem item)
        {
            ...
            if (item.SecurityProtocolType != null) ServicePointManager.SecurityProtocol = item.SecurityProtocolType;
        ...
        private void SetProxy(HttpItem item)
        {
            ...
            {
                //设置为IE代理
                // 什么都不设置，默认的就是ie代理，这是微软干的，
                // 默认设置 ProxyIp=ieproxy，就会默认使用Ie代理
            } 
        }
    ...
    public class HttpItem
    {
        ...
        /// 什么都不设置，默认的就是ie代理，这是微软干的，
        ///yixiu update 2016-3-15 默认设置 ProxyIp=ieproxy，就会默认使用Ie代理
        /// </summary>
        ...
        #region https有时需要设置协议类型 比如设置为：SecurityProtocolType.Tls
    ...
    public class HttpResult
    {
        ...
        /// <summary>
        /// 2016-4-14 add by yixiu
        /// 异常，如果下载过程中出现异常，保存到下载结果中；没有异常就是null
        /// </summary>
